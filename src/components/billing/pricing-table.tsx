...
const PLANS = [
    {
        ...
        features: ['5 Triggers', '100 Executions/mo', '15-min Interval', 'Community Support'],
        current: false,
    },
    {
        id: 'hobbyist',
        ...
        features: ['20 Triggers', '5,000 Executions/mo', '1-min Interval', 'Email Support'],
        current: false,
    },
    {
        id: 'pro',
        ...
        features: ['50 Triggers', '20,000 Executions/mo', '1-min Interval', 'Team Access', 'Priority Support'],
        current: false,
    },
    {
        id: 'business',
